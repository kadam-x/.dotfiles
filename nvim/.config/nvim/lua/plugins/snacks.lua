    ...
    config = function()
      ...
      ╚═════╝ ╚═╝  ╚═══╝╚══════╝╚══════╝  ╚═══╝  ╚═╝╚═╝     ╚═╝]],
                    keys = {
                        ...
                        { icon = " ", key = "c", desc = "Config Files", action = function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end },
        ...
        vim.keymap.set("n", "<leader>fc", function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end, { desc = "Neovim Config Files" })
